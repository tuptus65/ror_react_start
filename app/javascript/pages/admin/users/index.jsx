      ...
      <AdminLayout>
        ...
        <div className="flex flex-col gap-2 w-full mt-2">
          <header className="shadow-md mb-2 w-full py-2 px-2 rounded-md">
            <h1 className="text-4xl font-serif font-bold">{t('admin/users.index.title')}</h1>
          </header>
          ...
          <Table>
            <TableHead>
              <tr>
                <th className="px-6 py-3 text-left">{t('attribute_names.name')}</th>
                <th className="px-6 py-3 text-left">{t('attribute_names.email')}</th>
                <th className="px-6 py-3 text-left">{t('attribute_names.roles')}</th>
                <th></th>
              </tr>
            </TableHead>
            <tbody>
